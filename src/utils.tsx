import { FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaThreads, FaTwitter, FaXTwitter, FaYoutube, FaBlogger } from "react-icons/fa6";
...
export const getPlatformIconByName = (platformName: string): JSX.Element | null => {
    switch (platformName) {
        ...
        case 'kakaotalk': {
            return <SiKakaotalk size={24} className='min-w-fit' />;
        }
        case 'naver': {
            return <SiNaver size={24} className='min-w-fit' />;
        }
        case 'naverblog': {
            return <FaBlogger size={24} className='min-w-fit' />;
        }
        default:
